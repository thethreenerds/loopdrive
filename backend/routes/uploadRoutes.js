...
const { handleUpload, getMyUploads, searchSamples, updateSample, deleteSample, deleteSamples } = require('../controllers/uploadController');
...
router.delete('/batch', verifyToken, deleteSamples);
